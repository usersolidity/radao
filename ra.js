(function (window) {
  ...
  const daoAbi = [
    ...
    "function proposals(uint256) view returns (uint256, address, string, string, uint256, uint256, uint256, uint256, uint256, uint256)",
    ...
    "function voteBySignature(uint256,uint256,uint8,bytes32,bytes32)",
